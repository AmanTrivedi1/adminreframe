...
//     // API call to make the property live
//     // After API call, update property state:
...
//                           <span className="relative animate-pulse inline-flex rounded-full h-3 w-3 bg-green-600"></span>
//                         </span>
//                       ) : (
//                         <span className="relative flex h-3 w-3">
...
//                   <div>
//                     {!property.isLive && (
//                       <div className="flex items-center px-2 gap-x-2 mb-2 ">
//                         <Drawer>
//                           <DrawerTrigger className="w-full">
//                             <Button variant="live" className="w-full border">
//                               Make live
//                             </Button>
//                           </DrawerTrigger>
...
//                               </DrawerTitle>
//                               <DrawerDescription>
//                                 This action will make the property live, and it
//                                 will be visible to users. This action cannot be
//                                 re-done.
//                               </DrawerDescription>
//                             </DrawerHeader>
//                             <DrawerFooter>
...
//                               >
//                                 {isSubmitting ? "Processing..." : "Go Live"}
//                               </Button>
//                               <DrawerClose>
...
//                           </DrawerContent>
//                         </Drawer>
//                         <Button className="w-full gap-x-2 flex items-center">
//                           Edit
...
//                               </DrawerTitle>
//                               <DrawerDescription>
//                                 This action will hide the property from users,
//                                 and it will no longer be visible. You can make
//                                 it live again later.
//                               </DrawerDescription>
//                             </DrawerHeader>
              ...
              {properties.map((property) => (
                ...
                >
                  ...
                  <CardFooter className="flex gap-x-2 justify-between">
                    ...
                    <Button variant="outline" className="w-full gap-x-1">
                      <Edit size={12} />
                      Edit
                    </Button>
                  </CardFooter>
